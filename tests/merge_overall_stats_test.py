...
class TestMerge(TestBase):
    ...
    def setUp(self):
        ...
        self.output_file = "ind_merged_stats.csv"
    ...
    def test_merge_1(self):
        command = ["rfc", "merge", "overall-stats",
        ...
        # TODO: Add this test to genome stats tests later
        """
        self.assertEqual(result_df.loc["genome_unaligned"]["GSM1606107.1"], 8028)
        self.assertEqual(result_df.loc["genome_unaligned"]["GSM1606107.2"], 7628)
        """
        
        self.assertEqual(result_df.loc["clipped_reads"]["GSM1606107.1"], 484302)
        self.assertEqual(result_df.loc["clipped_reads"]["GSM1606107.2"], 482201)
